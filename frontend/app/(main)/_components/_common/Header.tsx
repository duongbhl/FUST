...
import { Bell, CircleUserRound, Map, Globe } from "lucide-react";
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full hover:bg-gray-100 text-gray-700 transition"
